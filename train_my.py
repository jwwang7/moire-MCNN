...
import logging
import argparse
from utils_my import MoirePic, weights_init
from net_my import MoireCNN

torch.cuda.set_device(0)

parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                 description='Demo for showing results')
parser.add_argument('-d', '--dataset', dest='dataset', type=str, default='D:/pyc/MCNN/trainData',
...
if __name__ == '__main__':
    ...
    for epoch in range(50):
        ...
        if current_loss < best_loss:
            ...
            torch.save(model, os.path.join(par.save, 'moire_best1.pth'))
