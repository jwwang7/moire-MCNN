...
class MoireCNN(nn.Module):
    ...
    def conv_block(self, channels):
        #old part
        # convs = [nn.Conv2d(channels, channels, 3, 1, 1), nn.ReLU(True)]
    ...
    def forward(self, x):
        ...
        # x1 = self.s13(self.s13(self.s13(self.s13(self.s13(x1)))))
        # x2 = self.s23(self.s23(self.s23(self.s23(self.s23(x2)))))
        # x3 = self.s33(self.s33(self.s33(self.s33(self.s33(x3)))))
        # x4 = self.s43(self.s43(self.s43(self.s43(self.s43(x4)))))
        # x5 = self.s53(self.s53(self.s53(self.s53(self.s13(x5)))))
        #
        # x1 = self.s12(x1)
        # x2 = self.s22(x2)
        # x3 = self.s32(x3)
